...
```javascript
isArrayArray = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-array-array@v0.2.2-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/assert-is-array-array/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/assert-is-array-array/actions/workflows/test.yml?query=branch:v0.2.2
